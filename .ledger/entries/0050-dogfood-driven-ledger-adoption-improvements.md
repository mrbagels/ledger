...
- What changed: Renamed the npm package to `@mrbagels/ledger`, added public
...
Users can now run `pnpm dlx @mrbagels/ledger`, adopt Ledger in existing repos,
...
The first real npm publish attempt was blocked because this machine is not
authenticated to npm (`npm whoami` returned `E401`). Complete npm account login,
